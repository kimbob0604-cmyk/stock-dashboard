...
#
# 실측(2026-09-16, ohlcv-probe.yml 러너): 252거래일 구간을 네이버에서
# **종목당 1.04초**(20종목 20.7초, 아래 REQUEST_GAP 포함). 그래서
#   200종목 ≈ 3.5분 · 300종목 ≈ 5.2분 · 500종목 ≈ 8.6분
# 300 이면 5분 남짓이라 부팅(데몬 스레드라 Flask 를 막지 않는다)과 장마감 후
# 실행에 무리가 없고, 19:00 시황까지 세 시간 가까이 여유가 남는다.
